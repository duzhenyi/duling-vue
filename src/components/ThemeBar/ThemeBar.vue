  ...
  >
    <a-form :model="form">
      ...
      <a-form-model-item label="" v-bind="formItemLayout">
        <a-radio-group v-model="form.layout"  default-value="horizontal" button-style="solid">
      ...
      <a-form-model-item label="菜单颜色" v-bind="formItemLayout">
        <color-select @selectColorFun="selectColorFun" type="sketch" ></color-select>
      </a-form-model-item>
      ...
      <a-form-model-item label="颜色风格" v-bind="formItemLayout">
        <a-radio-group v-model="form.menuTheme">
          <a-radio value="topbar-dark">暗色</a-radio>
          <a-radio value="topbar-light">亮色</a-radio>
        </a-radio-group>
      </a-form-model-item>
      ...
      <a-form-model-item label="颜色风格" v-bind="formItemLayout">
        <a-radio-group v-model="form.menuTheme">
          <a-radio value="side-dark">暗色侧</a-radio>
          <a-radio value="side-light">亮色侧</a-radio>
        </a-radio-group>
      </a-form-model-item>
      <a-form-model-item label="侧边栏展示到左侧" v-bind="formItemLayout">
        <a-switch v-model="form.fixedSideBarToLeft" />
      </a-form-model-item>
      <a-form-model-item label="侧边栏开启手风琴模式" v-bind="formItemLayout">
        <a-switch v-model="form.sidebarOpensAccordionMode" />
      </a-form-model-item>
      <a-form-model-item label="显示折叠侧边栏按钮" v-bind="formItemLayout">
