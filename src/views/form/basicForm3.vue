<template>
  ...
  >
    ...
    <a-form-model-item label="Activity zone" prop="region">
      <a-select v-model="form.region" :disabled="true" placeholder="please select your zone">
    ...
    <a-form-model-item label="Instant delivery" prop="delivery">
      <a-switch :disabled="true" v-model="form.delivery" />
    </a-form-model-item>
    <a-form-model-item label="Activity type" prop="type">
      <a-checkbox-group v-model="form.type" :disabled="true">
    ...
    <a-form-model-item label="Resources" prop="resource">
      <a-radio-group v-model="form.resource" :disabled="true">
        <a-radio value="1">
          Sponsor
        </a-radio>
        <a-radio value="2">
    ...
    <a-form-model-item label="Activity form" prop="desc">
      <a-input :disabled="true" v-model="form.desc" type="textarea" />
    </a-form-model-item>
